...
class worker_update extends StatefulWidget {
  @override
  _worker_updateState createState() =>
      _worker_updateState();
}

class _worker_updateState extends State<worker_update> {
  String _email;
  String _password;
  String _city;
  String _phone;
  ...
  updateData(String _name,String _city, String _phone,String _occupation )
  {
      ...
      body: SingleChildScrollView(
        child: StreamBuilder(
            ...
            builder:
              ...
              final TextEditingController controller_occupation = new TextEditingController(text: snapshot.data.docs[0]['Occupation']);
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        child: TextFormField(
                          style: TextStyle(color: Colors.white),
                          controller: controller_occupation,
                          decoration: InputDecoration(
                              focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: Colors.greenAccent[400],
                              ...
                              labelText: 'Occupation',labelStyle: TextStyle(color: Colors.white)),
                          validator: (value) => value.isEmpty ? 'Occupation can\'t be empty' : null,
                        ),
                      ),
                      new Padding(
                      ...
                      RaisedButton(
                        onPressed: () {
                          ...
                          _occupation = controller_occupation.text;

                          updateData(_name,_city,_phone,_occupation);
