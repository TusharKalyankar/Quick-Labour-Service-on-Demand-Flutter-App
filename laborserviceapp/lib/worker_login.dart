...
import 'package:loginmodulepnwr/create_worker.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'forgot_password.dart';

class WorkerLoginPage extends StatefulWidget {
  WorkerLoginPage({this.auth, this.onSignedIn});
  final BaseAuth auth;
  final VoidCallback onSignedIn;

  @override
  State<StatefulWidget> createState() => _WorkerLoginPageState();
}
...
class _WorkerLoginPageState extends State<WorkerLoginPage> {
  ...
  List<Widget> buildInputs() {
    return [
      ...
      SizedBox(height: 10,),
      Text('Welcome To SerOne',style: TextStyle(fontSize: 30,color: Colors.white,fontWeight: FontWeight.bold),),
      SizedBox(height: 40,),
      Container(
        ...
        RaisedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => WorkerRegisterationPage(
                  auth: Auth(),
                ),
              ),
            );
